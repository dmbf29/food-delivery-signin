...
def replace_choice(batch_number)
  ...
  system("cp -rf food-delivery-day-two-lecture-#{batch_number}/app/views/meals_view.rb app/views")
  system("cp -rf food-delivery-day-two-lecture-#{batch_number}/app/views/customers_view.rb app/views")
