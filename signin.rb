...
if directory_location[-41..-1] == correct_dir
  puts "You're in the right location 👌"
else
...
puts "Cloning live code repo..."
succeed = system("git clone git@github.com:dmbf29/food-delivery-#{batch_number}.git")
unless succeed
  puts "⚠️⚠️⚠️"
...
choice = nil
until ['signin', 'replace'].includes?(choice)
  puts
